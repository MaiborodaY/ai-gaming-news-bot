    ...
    const response = await fetch(OPENAI_API_URL, {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            // Keep posts lively, but avoid marketing claims and unsupported facts.
            content:
              'Ты редактор Telegram-канала BroNews World про игровые новости. Пиши живо, коротко и понятно на русском языке, но оставайся нейтральным: не добавляй маркетинговых формулировок и рекламу, не преувеличивай события и не приукрашивай факты. Не выдумывай факты, которых нет в заголовке. Не используй Markdown-разметку, жирный текст, списки и хэштеги.'
          },
          {
            role: 'user',
